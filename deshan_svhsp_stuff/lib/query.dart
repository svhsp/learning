...
class SearchLocations extends SearchDelegate<String> {
  ...
  //             return ListTile(title: Text(allLocations[index]));
  //           });
  ...
  //
  //             return ListView.builder(itemCount: allSuggestions.length, itemBuilder: (context, index) {
  //               return ListTile(title: Text(allSuggestions[index]));
  //             });
  //           } else if (snapshot.connectionState == ConnectionState.waiting) {
  //             return CircularProgressIndicator();
  //           } else if (snapshot.hasError) {
